...
async function runInteractiveVizpadTest() {
  try {
    ...
    const url = vizUrl.trim() === '' ? 'https://galaxyai.bayer.com/dashboard/72ed4cae-f8c3-4d20-a8d3-897355f56d36/875c7d53-6502-4b78-a1e7-588104950912?utm_source=c2cd4d7b-be2e-4938-812d-f8e0fb4c1bbd' : vizUrl.trim();
    ...
    const tabSwitch = isTabSwitch.trim() === '' ? 'false' : isTabSwitch.trim();
